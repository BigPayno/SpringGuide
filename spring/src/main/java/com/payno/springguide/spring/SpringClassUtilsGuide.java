...
public class SpringClassUtilsGuide {
    ...
    public void localClass(){
         ...
         */
        System.out.println(
                ClassUtils.isPresent("com.payno.springguide.config.TestConfiguration",ClassUtils.getDefaultClassLoader().getParent())
        );
        System.out.println(
                ClassUtils.isPresent("java.utils.List",ClassUtils.getDefaultClassLoader())
        );
        System.out.println(
                ClassUtils.isPresent("com.payno.springguide.config.TestConfiguration",ClassUtils.getDefaultClassLoader())
        );
        /**
         * 不同加载器加载的类是不一样的
         * 哪怕同样的地址
